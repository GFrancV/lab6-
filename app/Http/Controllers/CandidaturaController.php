...
class CandidaturaController extends Controller
{
    public function create(){
        ...
        return view('candidaturas.create', ['cursos' => $cursos]);
    }
    ...
    public function store(Request $request){
        ...
        $newCandidatura = Candidatura::create($validateData);
        ...
        if (array_key_exists('estatutos', $validateData)) {
            $candidaturas_estatutos[0]['pretende'] =
            in_array("TE", $validateData['estatutos']) ? '1' : '0';
            $candidaturas_estatutos[1]['pretende'] =
            in_array("NE", $validateData['estatutos']) ? '1' : '0';
            $candidaturas_estatutos[2]['pretende'] =
            in_array("E", $validateData['estatutos']) ? '1' : '0';
        }
